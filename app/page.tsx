          ...
          {user ? (
            <div className="flex flex-col gap-4 items-center">
              ...
              <a 
                ...
                className="bg-linear-to-r from-purple-600 via-pink-600 to-orange-500 hover:from-purple-700 hover:via-pink-700 hover:to-orange-600 text-white font-bold py-3 px-8 rounded-full flex items-center gap-3 shadow-lg transition duration-300"
              >
